...
_land_types = [
    ...
    Feature('landuse', 'industrial port',                          StyleArea('#ffc', 0), FilterTrue),
    Feature('landuse', 'retail commercial',                        StyleArea('#cff', 0), FilterTrue),
    Feature('amenity', 'school kindergarten college university',   StyleArea('#fcf', 0), FilterTrue),
