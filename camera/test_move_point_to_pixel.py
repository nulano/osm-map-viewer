...
print('testing camera.move_point_to_pixel')
test_count = 0
correct_tests = 0
failure = None

with open('testdata/move_to_pix.in', 'r') as f:
    ...
    for i in range(world_count):
        ...
        for j in range(testcases_count):
            ...
            point_lat, point_lon, pix_x, pix_y = map(float, f.readline().split())
            cam.move_point_to_pixel((point_lat, point_lon), (pix_x, pix_y))
